...
pub(super) fn host_return_type(module: &str, name: &str) -> Option<&'static str> {
    Some(match (module, name) {
        ...
        ("__ui", "theme_get") => "Map",
        ("__ui", "last_alert" | "open" | "save") => "Option",
        ("__ui", "run") => "Int",
        ("__ui", "field" | "select") => "String",
        ("__ui", "checkbox") => "Bool",
        ("__ui", "slider") => "Float",
        _ => return None,
    })
...
pub fn stdlib_arity(module: &str, name: &str) -> Option<usize> {
    Some(match (module, name) {
        ...
        (
            "__ui",
            "theme" | "alert" | "begin" | "widget" | "field" | "checkbox" | "slider" | "select",
        ) => 1,
        ("__ui", "window" | "bind") => 2,
        (
            "__ui",
            "end" | "run" | "pump" | "last_alert" | "theme_get" | "quit" | "invalidate" | "open"
            | "save",
        ) => 0,
        ("Array", "first" | "last") => 1,
        ("Array", "contains") => 2,
